import { OperationHoursDto, PropertyInformationDto, RecentImprovementsDto, ThirdPartyLinksDto } from './create-draft.dto';
export declare class UpdateDraftBusinessDto {
    dummyImage: string;
    images: string[];
